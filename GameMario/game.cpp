...
void Game::Load(LPCWSTR gameFile)
{
	...
	ifstream f;
	f.open(gameFile);
	char str[MAX_CHARACTER_IN_LINE];

	// current resource section flag
	int section = GAME_FILE_SECTION_UNKNOWN;

	while (f.getline(str, MAX_CHARACTER_IN_LINE))
	{
		string line(str);
...
void Game::LoadSharedResource(LPCWSTR filePath)
{
...
void Game::SwitchScene(int scene_id)
{
	...
	//AnimationDatabase::GetInstance()->Clear();
