...
#define GAME_FILE_SECTION_ENDTITLE_ITEMS						6
#define GAME_FILE_SECTION_POSITION_IN_ENDTITLE					7
...
#define OBJECT_TYPE_MOVING_BRICK								11
#define OBJECT_TYPE_BOOMERANG_BROTHERS							12
